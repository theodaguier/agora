...
import { Card, Description, Input, Label, ListGroup, TextField, Typography } from "heroui-native";
...
const messages = defineMessages({
  en: { agents: "Agents", models: "Models", availability: "Availability", all: "All agents", none: "No agents", some: (n: number, total: number) => `${n} of ${total} agents` },
  fr: {
    agents: "Agents",
    models: "Modèles",
